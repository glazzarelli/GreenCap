      ...
      <div class="container px-5 py-18 mx-auto flex flex-wrap">
        <div class="lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden">
          <img alt="feature" class="object-cover object-center h-full w-full"
            :src="'/images/areas/' + area.name.replace(/ /g, '-') + '.png'">
        </div>
        <div class="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center">
          <div class="flex flex-col mb-10 lg:items-start items-center">
            <div class="flex-grow">
              <h2 class="text-lg title-font font-medium mb-3">{{ area.descriptionLong }}</h2>
              <p class="items-end" style="font-weight: bold; font-size: 18px;">In this area we already invested: {{
                area.totalInvestment }} €</p>
            </div>
          </div>
        </div>
      </div>
