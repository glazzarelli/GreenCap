    ...
    const projectModel = [
        {
            ...
            image: "https://raw.githubusercontent.com/glazzarelli/GreenCap/main/assets/img/Projects/Artificial%20meat.png?token=GHSAT0AAAAAACB3LDEBWTSYU4WROFDZFESIZCSGSRA",
            team: ["Bart", "Lisa", "Maggie", "Homer", "Marge"],
            descriptionShort: "Artificial meat is a sustainable and ethical alternative to traditional meat production, produced by in vitro cultivation of animal cells in a lab setting. It has the potential to address environmental, animal welfare, and public health concerns associated with conventional meat production.", 
        ...
        {
            name: "Windpower",
            image: "https://raw.githubusercontent.com/glazzarelli/GreenCap/main/assets/img/Projects/windpower.png?token=GHSAT0AAAAAACB3LDEA4DVKR74PGBUXBMK2ZCSHH6Q",
            team: ["Boe", "Lisa", "Maggie", "Homer", "Marge"],
            descriptionShort: "Vertical wind turbines are a type of wind turbine with a vertical main rotor shaft that can operate in turbulent and gusty winds from any direction, making them ideal for urban areas. They have a smaller footprint and can be installed at lower heights, making them more accessible and easier to maintain.",
        ...
        {
            name: "Solar roads",
            image: "https://raw.githubusercontent.com/glazzarelli/GreenCap/main/assets/img/Projects/solar%20roads.png?token=GHSAT0AAAAAACB3LDEAFBKI6WK5EGVH7OA6ZCSHI3Q",
            team: ["Boe", "Lisa", "Maggie", "Homer", "Marge"],
            descriptionShort: "Solar roads are a renewable energy technology that embeds solar panels into roadways to generate electricity, which can power streetlights, electric vehicles, and buildings. The technology has the potential to reduce carbon emissions and promote sustainability. ",
        ...
        {
            name: "Wind-solar hybrid technology",
            image: "https://raw.githubusercontent.com/glazzarelli/GreenCap/main/assets/img/Projects/Wind-solar%20.png?token=GHSAT0AAAAAACB3LDEB2ENFVWC2VQ3JFNU4ZCSHJIQ",
            team: ["Boe", "Lisa", "Maggie", "Homer", "Marge"],
            descriptionShort: "Wind-solar hybrid technology is a renewable energy solution that combines wind turbines and solar panels to generate electricity. The technology uses a unique blade system and high-efficiency photovoltaic cells to maximize energy production from both wind and solar sources.",
        ...
        },
        {
            ...
            image: "https://raw.githubusercontent.com/glazzarelli/GreenCap/main/assets/img/Projects/waste%20sink.png?token=GHSAT0AAAAAACB3LDEBS6MNS52TGQRUWEHOZCSHJTA",
            team: ["Boe", "Lisa", "Maggie", "Homer", "Marge"],
            descriptionShort: "The waste disposal sink is a new technology that sorts and transports waste to the appropriate recycling or disposal location. The sink is equipped with a shredder and a system of sensors and pipes that identify and sort different types of waste. It promotes recycling and reduces the environmental impact of waste disposal.",
            ...
            {
            name: "Uphill Road",
            image: "https://raw.githubusercontent.com/glazzarelli/GreenCap/main/assets/img/Projects/Uphill%20Road.png?token=GHSAT0AAAAAACB3LDEAJRVE5PZKKWDX466EZCSHKKA",
            team: ["Boe", "Lisa", "Maggie", "Homer", "Marge"],
            descriptionShort: "The bike escalator is a new technology designed to help cyclists easily navigate hills and other steep inclines. It is essentially a series of conveyor belts that run parallel to a bike path, allowing cyclists to ride their bikes onto the belts and be carried up the hill. The system is safe and easy to use, with non-slip materials, handrails, and barriers. It is powered by electricity and has minimal impact on the environment.",
        ...
        {
            name: "Smart Road",
            image: "https://raw.githubusercontent.com/glazzarelli/GreenCap/main/assets/img/Projects/The%20green%20road.png?token=GHSAT0AAAAAACB3LDEBYSZTQKKLADFUZIEGZCSHK5Q",
            team: ["Boe", "Lisa", "Maggie", "Homer", "Marge"],
            descriptionShort: "A smart road equipped with wireless charging coils embedded into the surface can recharge electric vehicles while they are in motion, eliminating the need for drivers to stop and plug in their cars at charging stations. This innovative technology has the potential to revolutionize transportation and reduce our reliance on fossil fuels.",
        ...
        {
            name: "Green roofs",
            image: "https://raw.githubusercontent.com/glazzarelli/GreenCap/main/assets/img/Projects/Green%20roofs.png?token=GHSAT0AAAAAACB3LDEANM6MYRICCZYI6MDAZCSHLVQ",
            team: ["Boe", "Lisa", "Maggie", "Homer", "Marge"],
            descriptionShort: "Green roofs are sustainable roofing systems that support vegetation and soil on top of a building. They provide natural insulation, reduce heat island effect, absorb rainwater, improve air quality, and enhance the aesthetic value of a building. ",
        ...
        {
            name: "EcoHomes",
            image: "https://raw.githubusercontent.com/glazzarelli/GreenCap/main/assets/img/Projects/Eco%20Homes.png?token=GHSAT0AAAAAACB3LDEBZE6ZD3Q7FINWTOOKZCSHL7A",
            team: ["Boe", "Lisa", "Maggie", "Homer", "Marge"],
            descriptionShort: "Net zero energy buildings are sustainable buildings that generate as much energy as they consume over a year. They are designed to be highly energy-efficient and typically incorporate renewable energy sources to power the building, thus reducing greenhouse gas emissions and promoting sustainability.",
        ...
        {
            name: "Smart farming ",
            image: "https://raw.githubusercontent.com/glazzarelli/GreenCap/main/assets/img/Projects/samrtfarming.png?token=GHSAT0AAAAAACB3LDEBT6YPNKZFHQ3W5WVEZCSHNKA",
            team: ["Boe", "Lisa", "Maggie", "Homer", "Marge"],
            descriptionShort: "Precision farming is an advanced agricultural approach that leverages technology to optimize crop production while minimizing waste. It involves real-time data collection and analysis using advanced tools like GPS, sensors, drones, and machine learning algorithms, enabling farmers to make informed decisions on planting, fertilization, irrigation, and pest management. ",
        ...
        {
            name: "Permaculture ",
            image: "https://raw.githubusercontent.com/glazzarelli/GreenCap/main/assets/img/Projects/Permaculure.png?token=GHSAT0AAAAAACB3LDEAB3UXIXZVZOC6RTWWZCSHNZQ",
            team: ["Boe", "Lisa", "Maggie", "Homer", "Marge"],
            descriptionShort: "Permaculture is a sustainable and holistic approach to agriculture and design that uses natural principles and patterns to create self-sufficient and ecologically balanced systems. It focuses on using renewable resources, waste reduction, and the integration of plants and animals to create a productive and sustainable ecosystem.",
        ...
        {
            name: "Insecta",
            image: "https://raw.githubusercontent.com/glazzarelli/GreenCap/main/assets/img/Projects/Insecta.png?token=GHSAT0AAAAAACB3LDEALU24KCBQWDBOTRFKZCSHOEA",
            team: ["Boe", "Lisa", "Maggie", "Homer", "Marge"],
            descriptionShort: "Insect farming is the process of breeding and raising insects for human consumption and other uses. Insects are high in protein, require less water and land than traditional livestock, and have the potential to be a sustainable and efficient source of food.",
        ...
        {
            name: "Hydrogrow",
            image: "https://raw.githubusercontent.com/glazzarelli/GreenCap/main/assets/img/Projects/Hydro%20Grow.png?token=GHSAT0AAAAAACB3LDEA5ISCP3YKWLKEIZUKZCSHONQ",
            team: ["Boe", "Lisa", "Maggie", "Homer", "Marge"],
            descriptionShort: "Hydrogrow is a start-up that specializes in developing and implementing sustainable hydroponic farming solutions for urban agriculture.",
        ...
        {
            name: "Rivercross",
            image: "https://raw.githubusercontent.com/glazzarelli/GreenCap/main/assets/img/Projects/Rivercross.png?token=GHSAT0AAAAAACB3LDEAGN3FIV26JFUHBZP2ZCSHOVQ",
            team: ["Boe", "Lisa", "Maggie", "Homer", "Marge"],
            descriptionShort: "Rivercross is a startup that creates sustainable and innovative solutions for water management. They specialize in developing technology and systems to improve water quality, reduce waste, and promote conservation.",
        ...
        {
            name: "Solar genius",
            image: "https://raw.githubusercontent.com/glazzarelli/GreenCap/main/assets/img/Projects/Genius.png?token=GHSAT0AAAAAACB3LDEACZBZSI63QVIDX5FYZCSHPBA",
            team: ["Boe", "Lisa", "Maggie", "Homer", "Marge"],
            descriptionShort: "Solar Genius is a startup focused on providing renewable energy solutions to homes and businesses. They specialize in solar panel installations and offer a range of services including consultation, design, installation, and maintenance. Their goal is to help people reduce their reliance on fossil fuels and transition to cleaner energy sources.",
    ...
    const areaModel = [
        {
            ...
            image: "https://raw.githubusercontent.com/glazzarelli/GreenCap/main/assets/img/Areas/Renewable%20energy.png?token=GHSAT0AAAAAACB3LDEANQFCH75M3BUNEC5YZCSHPSQ",
        ...
        },
        {
            ...
            image: "https://raw.githubusercontent.com/glazzarelli/GreenCap/main/assets/img/Areas/Transport.png?token=GHSAT0AAAAAACB3LDEA6FD7NFWDJKDTCWQ2ZCSHP3A",
        ...
        },
        {
            ...
            image: "https://raw.githubusercontent.com/glazzarelli/GreenCap/main/assets/img/Areas/Green%20building.png?token=GHSAT0AAAAAACB3LDEAPMNUYA2CMEU4HNRQZCSHQPA",
        ...
        {
            name: "Sustainable agriculture and food production",
            image: "https://raw.githubusercontent.com/glazzarelli/GreenCap/main/assets/img/Areas/Agriculture.png?token=GHSAT0AAAAAACB3LDEBTD3UEHCSBPJEF5REZCSHQZA",
    ...
    const personModel = [
        {
            ...
            catchphrase: "I believe that sustainable energy is the key to a better future for all.",
        },
        {
            name: "Fatima",
            surname: "Nakamura",
            ...
            catchphrase: "I am committed to finding innovative financing solutions that support sustainable growth."
        },
        {
            name: "Mei",
            surname: "Schmitt",
            ...
            catchphrase: "I am passionate about developing technologies that reduce our impact on the environment.",
        },
        {
            name: "Juan",
            surname: "Rodriguez",
            ...
            catchphrase: "I believe that consumers have the power to drive change, and I am committed to empowering them to make sustainable choices.",
        },
        {
            name: "Ahmed",
            surname: "Ali",
            ...
            catchphrase: "I am excited to apply my skills to projects that will have a positive impact on the environment and society.",
        },
        {
            name: "Liang",
            surname: "Gupta",
            ...
            catchphrase: "I am dedicated to finding solutions that balance economic growth with environmental protection.",
        },
        {
            name: "Emmanuel",
            surname: "Kowalska",
            ...
            catchphrase: "I am passionate about ensuring that sustainable development benefits all members of society.",
        },
        {
            name: "Julia",
            surname: "Sanchez",
            ...
            catchphrase: "I am committed to expanding our reach and developing partnerships that promote sustainable development.",
        },
        {
            name: "Jorgen",
            surname: "Lee",
            ...
            catchphrase: "I believe that investing in our employees is key to achieving our sustainability goals.",
        },
        {
            name: "Sofia",
            surname: "Chang",
            ...
            catchphrase: "I am dedicated to ensuring that our projects comply with international legal standards and promote sustainable development.",
        },
        
    ]

    const person0 = await models.Area.create(personModel[0])
    const person1 = await models.Area.create(personModel[1])
    const person2 = await models.Area.create(personModel[2])
    const person3 = await models.Area.create(personModel[3])
    const person4 = await models.Area.create(personModel[4])
    const person5 = await models.Area.create(personModel[5])
    const person6 = await models.Area.create(personModel[6])
    const person7 = await models.Area.create(personModel[7])
    const person8 = await models.Area.create(personModel[8])
    const person9 = await models.Area.create(personModel[9])
